...
con.connect(function(err) {
    ...
    var form = "CREATE TABLE IF NOT EXISTS cars (id int(11) NOT NULL AUTO_INCREMENT, brand VARCHAR(20), year YEAR, price INT, colour VARCHAR(20), description VARCHAR(250), image TEXT, PRIMARY KEY (id) )";
});
